...
void a64_interleaved_nomerge_bf16fp32bf16_mmla_6x8(
    const bfloat16_t *A,
    const bfloat16_t *B,
    bfloat16_t *C,
	...
	bfloat16_t beta)
{
  ...
  __asm__ __volatile__(
      ...
      "add x9, %x[Cpanel], %x[ldc], LSL #2\n"
      "cmp %x[M], #0x6\n"
      "add x28, x10, %x[ldc], LSL #2\n"
      ...
      "blt 5f\n"
      "4:"  // main loop head
      ".inst 0x6e43ec14  // bfmmla v20.4s, v0.8h, v3.8h\n"
      ".inst 0x6e43ec38  // bfmmla v24.4s, v1.8h, v3.8h\n"
      "sub x20, x20, #0x2\n"
      ".inst 0x6e43ec5c  // bfmmla v28.4s, v2.8h, v3.8h\n"
      "ldr q3, [x23, #0x40]\n"
      ".inst 0x6e44ec16  // bfmmla v22.4s, v0.8h, v4.8h\n"
      ".inst 0x6e44ec3a  // bfmmla v26.4s, v1.8h, v4.8h\n"
      ".inst 0x6e44ec5e  // bfmmla v30.4s, v2.8h, v4.8h\n"
      "ldr q4, [x23, #0x50]\n"
      ".inst 0x6e45ec15  // bfmmla v21.4s, v0.8h, v5.8h\n"
      ".inst 0x6e46ec17  // bfmmla v23.4s, v0.8h, v6.8h\n"
      "ldr q0, [%x[Apanel], #0x30]\n"
      ".inst 0x6e45ec39  // bfmmla v25.4s, v1.8h, v5.8h\n"
      ".inst 0x6e46ec3b  // bfmmla v27.4s, v1.8h, v6.8h\n"
      "ldr q1, [%x[Apanel], #0x40]\n"
      ".inst 0x6e45ec5d  // bfmmla v29.4s, v2.8h, v5.8h\n"
      "ldr q5, [x23, #0x60]\n"
      ".inst 0x6e46ec5f  // bfmmla v31.4s, v2.8h, v6.8h\n"
      "ldr q2, [%x[Apanel], #0x50]\n"
      "ldr q6, [x23, #0x70]\n"
      "cmp x20, #0x2\n"
      ...
      "ldr q10, [x23, #0x30]\n"
      "add x23, x23, #0x40\n"
      ".inst 0x6e47ec14  // bfmmla v20.4s, v0.8h, v7.8h\n"
      ".inst 0x6e47ec38  // bfmmla v24.4s, v1.8h, v7.8h\n"
      ".inst 0x6e48ec16  // bfmmla v22.4s, v0.8h, v8.8h\n"
      ".inst 0x6e48ec3a  // bfmmla v26.4s, v1.8h, v8.8h\n"
      ".inst 0x6e47ec5c  // bfmmla v28.4s, v2.8h, v7.8h\n"
      ".inst 0x6e48ec5e  // bfmmla v30.4s, v2.8h, v8.8h\n"
      ".inst 0x6e49ec15  // bfmmla v21.4s, v0.8h, v9.8h\n"
      ".inst 0x6e4aec17  // bfmmla v23.4s, v0.8h, v10.8h\n"
      ".inst 0x6e49ec39  // bfmmla v25.4s, v1.8h, v9.8h\n"
      ".inst 0x6e4aec3b  // bfmmla v27.4s, v1.8h, v10.8h\n"
      ".inst 0x6e49ec5d  // bfmmla v29.4s, v2.8h, v9.8h\n"
      ".inst 0x6e4aec5f  // bfmmla v31.4s, v2.8h, v10.8h\n"
      "6:"  // multiply loop done
      "add x21, %x[args_ptr], %[offset_beta]\n"
      "add x20, %x[args_ptr], %[offset_alpha]\n"
      "uzp1 v11.2d, v20.2d, v22.2d\n"
      "ld1r { v8.4s }, [x21]\n"
      "ld1r { v7.4s }, [x20]\n"
      "cmp x24, #0x8\n"
      "uzp2 v20.2d, v20.2d, v22.2d\n"
      "uzp1 v22.2d, v21.2d, v23.2d\n"
      "uzp2 v21.2d, v21.2d, v23.2d\n"
      "uzp1 v23.2d, v24.2d, v26.2d\n"
      ...
      ".inst 0x4ea16b57  // bfcvtn2 v23.8h, v26.4s\n"
      ".inst 0x4ea16ab4  // bfcvtn2 v20.8h, v21.4s\n"
      ".inst 0x4ea16acb  // bfcvtn2 v11.8h, v22.4s\n"
      ...
      : "cc", "memory", "v0", "v1", "v10", "v11", "v16", "v17", "v18", "v19", "v2", "v20", "v21", "v22", "v23", "v24", "v25", "v26", "v27", "v28", "v29", "v3", "v30", "v31", "v4", "v5", "v6", "v7", "v8", "v9", "x10", "x20", "x21", "x22", "x23", "x24", "x25", "x26", "x27", "x28", "x9"
    );
}
