...
void a64_interleaved_nomerge_bf16fp32_mmla_4x12(
    const bfloat16_t *A,
    const bfloat16_t *B,
    float *C,
	...
	float beta)
{
  ...
  __asm__ __volatile__(
      ...
      "fmla v26.4s, v18.4s, v8.4s\n"
      "fmul v22.4s, v22.4s, v7.4s\n"
      "fmul v14.4s, v14.4s, v7.4s\n"
      "fmla v27.4s, v17.4s, v8.4s\n"
      "fmul v23.4s, v23.4s, v7.4s\n"
      "fmul v24.4s, v24.4s, v7.4s\n"
      "fmla v28.4s, v16.4s, v8.4s\n"
      "fmla v25.4s, v0.4s, v8.4s\n"
      "fmla v29.4s, v31.4s, v8.4s\n"
      "fmla v30.4s, v19.4s, v8.4s\n"
      "fmla v20.4s, v3.4s, v8.4s\n"
      "fmla v21.4s, v2.4s, v8.4s\n"
      "fmla v22.4s, v1.4s, v8.4s\n"
      "fmla v14.4s, v6.4s, v8.4s\n"
      "fmla v23.4s, v5.4s, v8.4s\n"
      "fmla v24.4s, v4.4s, v8.4s\n"
      "blt 15f\n"
      "str q26, [x25, #0x0]\n"
      "str q27, [x25, #0x10]\n"
      "str q28, [x25, #0x20]\n"
      ...
      "str q23, [%x[Cpanel], #0x10]\n"
      "str q24, [%x[Cpanel], #0x20]\n"
      ...
      "st1 { v20.4s }, [x26], #0x10\n"
      "st1 { v21.4s }, [x26], #0x10\n"
      "st1 { v14.4s }, [%x[Cpanel]], #0x10\n"
      "st1 { v23.4s }, [%x[Cpanel]], #0x10\n"
      "tbz x24, #1, 16f\n"
      "str d28, [x25], #0x8\n"
      "str d30, [x28], #0x8\n"
      "str d22, [x26], #0x8\n"
      "str d24, [%x[Cpanel]], #0x8\n"
      "tbz x24, #0, 21f\n"
      "st1 { v28.s }[2], [x25]\n"
      "st1 { v30.s }[2], [x28]\n"
      "st1 { v22.s }[2], [x26]\n"
      "st1 { v24.s }[2], [%x[Cpanel]]\n"
      "b 21f\n"
      ...
      "str d29, [x28], #0x8\n"
      "str d21, [x26], #0x8\n"
      "str d23, [%x[Cpanel]], #0x8\n"
      "tbz x24, #0, 21f\n"
      "st1 { v27.s }[2], [x25]\n"
      "st1 { v29.s }[2], [x28]\n"
      "st1 { v21.s }[2], [x26]\n"
      "st1 { v23.s }[2], [%x[Cpanel]]\n"
      "b 21f\n"
      ...
      "st1 { v25.s }[2], [x28]\n"
      "st1 { v20.s }[2], [x26]\n"
      "st1 { v14.s }[2], [%x[Cpanel]]\n"
      "b 21f\n"
      "20:"  // partial result store: partial_1_0
      "str s26, [x25, #0x0]\n"
      "str s25, [x28, #0x0]\n"
      "str s20, [x26, #0x0]\n"
      "str s14, [%x[Cpanel], #0x0]\n"
