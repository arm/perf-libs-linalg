...
<%namespace file="assembly_boilerplate.py.mako" import="prologue, epilogue"/>
	...
	<% func_name = "tran_interleave_12s_sve_512_kernel" %>
	${prologue(func_name)}
	stp x29, x30, [sp, #-16]!
	mov x29, sp
	...
	// setup interleave_width predicate. Size 48 bytes (12*4-byte elements)
	interleave_width .req x9
	mov  interleave_width, xzr
	incb interleave_width, vl16, mul #3
