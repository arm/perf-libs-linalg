...
#ifndef SGEMM_UNROLLED_NN_NMK_HPP
#define SGEMM_UNROLLED_NN_NMK_HPP
...
void unrolled_kernel_NN_nmk(const kernel_inttype m, const kernel_inttype n, const kernel_inttype k, const float alpha,
