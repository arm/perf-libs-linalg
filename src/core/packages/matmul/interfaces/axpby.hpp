...
#ifndef PERFLIBS_LINALG_BLAS_INTERFACES_AXPBY_HPP
#define PERFLIBS_LINALG_BLAS_INTERFACES_AXPBY_HPP
...
void axpby(
	...
	const promote_t<XType, YType> *beta,
	...
	const     kernel_inttype b_strd_stride = 0;
...
#endif //PERFLIBS_LINALG_BLAS_INTERFACES_AXPBY_HPP
