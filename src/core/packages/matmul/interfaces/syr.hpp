...
#ifndef PERFLIBS_LINALG_BLAS_INTERFACES_SYR_HPP
#define PERFLIBS_LINALG_BLAS_INTERFACES_SYR_HPP
...
inline constexpr std::string_view syr_name = "?SYR  ";

template<> inline constexpr std::string_view syr_name<r32, r32> = "SSYR  ";
template<> inline constexpr std::string_view syr_name<r64, r64> = "DSYR  ";
template<> inline constexpr std::string_view syr_name<c32, c32> = "CSYR  ";
template<> inline constexpr std::string_view syr_name<c64, c64> = "ZSYR  ";

template<typename IntType, typename XType, typename AType>
PERFLIBS_LINALG_INLINE
bool syr_param_check(
...
void syr(
	...
	if constexpr(ParamCheck) {
		const bool res = perflibs::linalg::syr_param_check(uplo, n, alpha, x, incx, a, lda,
			syr_name<XType, AType>);
...
#endif //PERFLIBS_LINALG_BLAS_INTERFACES_SYR_HPP
