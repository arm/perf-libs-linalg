...
#ifndef PERFLIBS_LINALG_BLAS_INTERFACES_HER2_HPP
#define PERFLIBS_LINALG_BLAS_INTERFACES_HER2_HPP
...
inline constexpr std::string_view her2_name = "?HER2 ";

template<> inline constexpr std::string_view her2_name<c32, c32, c32> = "CHER2 ";
template<> inline constexpr std::string_view her2_name<c64, c64, c64> = "ZHER2 ";

template<typename IntType, typename XType, typename YType, typename AType>
PERFLIBS_LINALG_INLINE
bool her2_param_check(
...
void her2(
	...
	if constexpr(ParamCheck) {
		const bool res = perflibs::linalg::her2_param_check(uplo, n, alpha, x, incx, y, incy, a, lda,
			her2_name<XType, YType, AType>);
	...
	spec::problem_context pctx {
		matmul::rank_update_2k {
			...
			general_matrix   {         matrix_base { b_ptr, cntg,   a_strd, b_cntg_stride, b_strd_stride }, true  },
			hermitian_matrix { c_uplo, matrix_base { c_ptr, a_strd, b_strd, c_cntg_stride, c_strd_stride }        },
			scalar_type { *alpha }, one<scalar_type>
		},
...
#endif //PERFLIBS_LINALG_BLAS_INTERFACES_HER2_HPP
