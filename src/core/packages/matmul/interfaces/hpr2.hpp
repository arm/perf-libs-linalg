...
inline constexpr std::string_view hpr2_name = "?HPR2 ";

template<> inline constexpr std::string_view hpr2_name<c32, c32, c32> = "CHPR2 ";
template<> inline constexpr std::string_view hpr2_name<c64, c64, c64> = "ZHPR2 ";

template<typename IntType, typename XType, typename YType, typename AType>
PERFLIBS_LINALG_INLINE
bool hpr2_param_check(
...
void hpr2(
	...
	if constexpr(ParamCheck) {
		auto res = perflibs::linalg::hpr2_param_check(
			uplo, n, alpha, x, incx, y, incy, ap,
				hpr2_name<XType, YType, AType>);
