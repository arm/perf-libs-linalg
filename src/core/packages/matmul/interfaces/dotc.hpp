...
#ifndef PERFLIBS_LINALG_BLAS_INTERFACES_DOTC_HPP
#define PERFLIBS_LINALG_BLAS_INTERFACES_DOTC_HPP
...
template<bool ParamCheck, typename IntType, typename XType, typename YType, typename ReturnType, typename ArchitectureSpec>
PERFLIBS_LINALG_INLINE
ReturnType dotc(const IntType *n, const XType *x, const IntType *incx, const YType *y, const IntType *incy) {
	...
	spec::problem_context pctx {
		matmul::matmul3 {
			general_matrix { matrix_base { x,  cntg,   a_strd, a_cntg_stride, a_strd_stride }, true  },
			general_matrix { matrix_base { y,  cntg,   b_strd, b_cntg_stride, b_strd_stride }, false },
			general_matrix { matrix_base { &c, a_strd, b_strd, c_cntg_stride, c_strd_stride }, false },
			alpha, beta
		},
...
#endif //PERFLIBS_LINALG_BLAS_INTERFACES_DOTC_HPP
