...
#ifndef PERFLIBS_LINALG_BLAS_INTERFACES_DOTU_HPP
#define PERFLIBS_LINALG_BLAS_INTERFACES_DOTU_HPP
...
ReturnType dotu(const IntType *n, const XType *x, const IntType *incx, const YType *y, const IntType *incy) {
...
#endif //PERFLIBS_LINALG_BLAS_INTERFACES_DOTU_HPP
